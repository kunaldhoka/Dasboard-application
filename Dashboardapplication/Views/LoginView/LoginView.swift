        ...
        VStack {
            ZStack {
                VStack {
                    ...
                    .frame(width: getRelativeWidth(161.0), height: getRelativeHeight(36.0),
                           alignment: .trailing)
                ...
                .frame(width: getRelativeWidth(319.0), height: getRelativeHeight(657.0),
                       alignment: .center)
                .padding(.top, getRelativeHeight(116.6))
