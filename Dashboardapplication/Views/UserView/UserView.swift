                    ...
                    ZStack(alignment: .topTrailing) {
                        ...
                        ZStack(alignment: .leading) {
                            ...
                            .frame(width: getRelativeWidth(104.0), height: getRelativeHeight(45.0),
                                   alignment: .leading)
                            .padding(.leading, getRelativeWidth(62.42))
                            .padding(.trailing, getRelativeWidth(85.58))
                        }
                        .hideNavigationBar()
                        .frame(width: getRelativeWidth(252.0), height: getRelativeHeight(50.0),
                               alignment: .bottomTrailing)
                        .padding(.top, getRelativeHeight(40.76))
                        .padding(.leading, getRelativeWidth(37.7))
                        ZStack {}
                            .hideNavigationBar()
